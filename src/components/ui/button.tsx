...
const buttonVariants = cva(
  clsx(
    "inline-flex items-center justify-center whitespace-nowrap rounded-full font-medium transition-colors gap-1.5",
  ...
  ),
  {
    variants: {
      variant: {
        ...
        secondary: "bg-background-field border hover:bg-euler-600 hover:border-border-strong",
      },
      size: {
        sm: "h-[32px] px-3 py-1.5 body-sm",
        lg: "h-[40px] px-3 py-[10px] body-md",
      },
    },
    defaultVariants: {
      variant: "primary",
